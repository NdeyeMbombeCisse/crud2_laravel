    ...
    <div class="container ">
        <div class="row">
          <div class="col">
            ...
            @endif
            {{-- "{{ url('update_article/'.$articles->id) }}" --}}
            ...
            <form action="{{ url('update_article/'.$articles->id) }}" method="POST">
                ...
                <div class="mb-3">
                    <label for="desc" class="form-label">Donner le description de l'article</label>
                    <input type="text" class="form-control" id="desc" name="desc" value="{{ $articles->desc}}">
                  </div>
                  <div class="mb-3">
                    <label for="date_creation" class="form-label">Donner le date de l'article</label>
                    <input type="date" class="form-control" id="date_creation" name="date_creation" value="{{ $articles->date_creation}}">
                  </div>
                  <div class="mb-3">
                    <label for="a_la_une" class="form-label">Donner le etat de l'article</label>
                    <input type="text" class="form-control" id="a_la_une" name="a_la_une" value="{{ $articles->a_la_une}}">
