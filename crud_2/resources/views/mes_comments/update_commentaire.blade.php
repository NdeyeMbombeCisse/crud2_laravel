    ...
    <div class="container ">
        <div class="row">
          <div class="col">
            ...
            @endif
            <form action="/comments_update/{{ $comments->id }}" method="POST">
                @csrf
                ...
                <div class="mb-1">
                  <label for="contenu" class="form-label">Donner le contenu de du commentaire</label>
                    <input type="text" class="form-control" id="contenu" name="contenu" accept="contenu/*"  value="{{ $comments->id }}"><br>
                  </div>
                <div class="mb-3">
                  <label for="auteur" class="form-label">Donner votre nom complet</label>
                  <input type="text" class="form-control" id="auteur" name="auteur"  value="{{ $comments->auteur }}">
                </div>
                <div class="mb-3">
                    <label for="date_heure_creation" class="form-label">Donner la date et l'heure de la creation</label>
                    <input type="datetime-local" class="form-control" id="date_heure_creation" name="date_heure_creation" value="{{ $comments->date_heure_creation }}">
                  </div>
                   <div class="mb-3">
